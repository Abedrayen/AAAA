...
import { getTopAssists, } from "../../API/API"
...
const TopAssists=()=>{
    ...
    useEffect(() => {
        const getStas = async () => {
          ...
          try {
            ...
            const response = await getTopAssists()
            ...
            if (response) {
              ...
              setTopAssists(formattedResponse);  // Correctly setting the top scorers
            }
    ...
    return (
        ...
        <h1 className="text-4xl font-bold text-[#1F5059]">{t('topAssissts')}</h1>
